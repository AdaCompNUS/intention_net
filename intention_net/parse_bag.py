...
MYNT_EYE = {
    ...
    'DEPTHS' : ['/train/mynteye/depth_img/compressed','/train/mynteye_1/depth_img/compressed',\
                '/train/mynteye_2/depth_img/compressed','/train/mynteye_3/depth_img/compressed'],
}
