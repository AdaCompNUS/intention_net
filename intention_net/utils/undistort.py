...
RIGHT_CAMERA_INFO = {
    ...
    'D': [-0.021799544117355064, -0.013164107936537923, 0.0319940345464826, -0.02443985962443235],
...
LEFT_CAMERA_INFO = {
    ...
    'D': [-0.023424071222704918, 0.0029950533726772295, -0.006144382406253766, 0.0014457766750990203],
...
if __name__ == '__main__':
    print('hello')
    for img in glob.glob("stitch2/*.jpg"):
        print(img)
        img = cv2.imread(img)
        img = undistort(img)
        plt.imshow(img)
